...
const Hero = () => {
  return (
    <div className='w-full h-full relative font-serif'>
        ...
        <div className='px-16 absolute w-full h-full top-0 flex flex-col justify-center text-center md:text-left text-white'>
            <div className='w-full md:w-2/3'>
                <h1 className='text-3xl md:text-4xl font-bold'>Modern IT and Tech <br/> Service Solution</h1>
                <p className='mt-4 text-sm md:text-[16px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna 
